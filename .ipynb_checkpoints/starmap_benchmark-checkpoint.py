...
for data_mode in data_modes:
    for sample_number in benchmark_samples:
            ...
            for split_version in range(10):
                ...
                h5ad_path = os.path.join(data_dir, "STARmap_20180505_BY3_1k_20240902231823.h5ad")
                adata = load_and_process_h5ad(h5ad_path)

                # 设置路径
                split_dir = r"./STARmap/4/DataSplit/all_gene"
...
results_df.to_csv("STARmap*_results.csv", index=False)
