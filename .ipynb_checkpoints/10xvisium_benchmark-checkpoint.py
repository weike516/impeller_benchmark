...
data_dir = r"./10XVisium/DLPFC/Preprocessed/151673"
data_modes = ["all_gene"]
# 初始化空列表用于保存所有结果
results = []
...
for data_mode in data_modes:
    for sample_number in benchmark_samples:
            ...
            for split_version in range(10):
                ...
                # 设置路径
                split_dir = r"./10XVisium/DLPFC/Preprocessed/151673/DataSplit/all_gene"
...
results_df.to_csv("10XVisium_results.csv", index=False)
