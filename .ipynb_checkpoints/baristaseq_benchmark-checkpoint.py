...
for data_mode in data_modes:
    for sample_number in benchmark_samples:
            ...
            for split_version in range(10):
                ...
                h5ad_path = os.path.join(data_dir, "Slice_2_20240902191808.h5ad")
                adata = load_and_process_h5ad(h5ad_path)

                # 设置路径
                split_dir = r"./Baristaseq/slice2/DataSplit/all_gene"
...
results_df.to_csv("baristaseq_results.csv", index=False)
